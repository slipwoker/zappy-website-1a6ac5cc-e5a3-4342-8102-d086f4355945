    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      requiredFields.forEach(function(field) {
        const errorMsg = field.parentElement.querySelector('.error-message') || 
                        field.nextElementSibling && field.nextElementSibling.classList.contains('error-message') ? 
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אתגר שירותי ליווי ולייעוץ עסקי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1a6ac5cc-e5a3-4342-8102-d086f4355945',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1a6ac5cc-e5a3-4342-8102-d086f4355945';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1a6ac5cc-e5a3-4342-8102-d086f4355945';
